...
export default function CandidateCard({ candidate, departments = DEFAULT_DEPARTMENTS, draggableProps, dragHandleProps, innerRef, dragging }) {
  ...
  return (
    <div
      ...
      className={`group cursor-pointer rounded-xl2 border border-ink-100 bg-paper-card p-3.5 shadow-card transition-shadow hover:shadow-pop ${dragging ? 'rotate-1 shadow-pop' : ''}`}
    >
